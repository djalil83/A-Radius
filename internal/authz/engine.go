...
// HasPermission performs server-side RBAC evaluation.
// It deliberately fails closed when the principal or permission is invalid.
...
if e == nil || e.db == nil {
return false, errors.New("authorization engine is not configured")
}
...
// RequirePermission is the application-level authorization gate.
